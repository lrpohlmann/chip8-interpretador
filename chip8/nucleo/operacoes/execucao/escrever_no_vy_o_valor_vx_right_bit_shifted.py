...
def escrever_no_vy_o_valor_vx_right_bit_shifted(vx: str, vy: str, contexto_runtime: CONTEXTO_RUNTIME) -> CONTEXTO_RUNTIME:
    return atualizar_contexto_runtime(contexto_runtime, "registradores", lambda reg: bitwise_shift_registradores(reg, vx, vy, "right"))
