...
from chip8.nucleo.operacoes.execucao.escrever_no_registrador_vx import (
    _escrever_no_registrador_vx,
)
from chip8.nucleo.operacoes.execucao.somar_no_registrador_vx import (
    _somar_no_registrador_vx,
)
from chip8.nucleo.operacoes.execucao.escrever_no_registrador_index import (
    _escrever_no_registrador_index,
)
...
) -> Callable[[CONTEXTO_RUNTIME], CONTEXTO_RUNTIME]:
    instrucao = ler_contexto_runtime(contexto_runtime, "ultima_instrucao")
    if instrucao == "00e0":
        return escrever_contexto_runtime(
            contexto_runtime, "ultima_execucao", limpar_tela
        )

    elif instrucao[0] == "1":
        return escrever_contexto_runtime(
            contexto_runtime, "ultima_execucao", decoder_1NNN(instrucao, _jump)
        )
        ...
        return escrever_contexto_runtime(
            contexto_runtime,
            "ultima_execucao",
            decoder_6XNN(instrucao, _escrever_no_registrador_vx),
        )
        ...
        return escrever_contexto_runtime(
            contexto_runtime,
            "ultima_execucao",
            decoder_7XNN(instrucao, _somar_no_registrador_vx),
        )
        ...
        return escrever_contexto_runtime(
            contexto_runtime,
            "ultima_execucao",
            decoder_ANNN(instrucao, _escrever_no_registrador_index),
        )
        ...
        return escrever_contexto_runtime(
            contexto_runtime,
            "ultima_execucao",
            decoder_DXYN(instrucao, _desenhar_na_tela),
        )
